...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 4
        "*** YOUR CODE HERE ***"
        # print("DEBUG do_define_form expressions:", expressions)
        if scheme_atomp(expressions.rest.first):
            env.define(signature, expressions.rest.first)
            # print("DEBUG do_define_form signature:", signature)
            # print("DEBUG do_define_form expressions.rest.first:", expressions.rest.first)
            # print("DEBUG do_define_form env:", env.bindings)
        else:
            env.define(signature, scheme_eval(expressions.rest.first, env))
        #     print("DEBUG", scheme_eval(expressions.rest.first, env))
        #     print("DEBUG do_define_form env:", env)
        ...
        # print("DEBUG",formals)
        lambdaExpressions = Pair('lambda',Pair(formals, expressions.rest))
        # print("DEBUG", lambdaExpressions)
        lastExpressions = Pair(symbol, Pair(lambdaExpressions, nil))
        # print("DEBUG", lastExpressions)
        return do_define_form(lastExpressions, env)
        # END PROBLEM 10
    else:
...
def do_and_form(expressions, env):
    ...
    # BEGIN PROBLEM 12
    "*** YOUR CODE HERE ***"
    # print("DEBUG do_and_form", env.bindings)
    if expressions == nil:
        return True
    res = None
...
def do_mu_form(expressions, env):
    ...
    # BEGIN PROBLEM 11
    "*** YOUR CODE HERE ***"
    muProcedure = MuProcedure(formals, expressions.rest)
    return muProcedure
    # END PROBLEM 11
