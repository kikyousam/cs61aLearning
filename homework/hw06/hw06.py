...
class VendingMachine:
    ...
    def vend(self):
        ...
        elif self.funds < self.stock_price:
            return f'Please add ${self.stock_price - self.funds} more funds.'
        else:
            if self.funds == self.stock_price:
                msg = 'Here is your '+self.commodity+'.'
            else:
                msg = 'Here is your '+self.commodity + f' and ${self.funds - self.stock_price} change.'
            self.funds = 0
            self.stock_num -= 1
            return msg
    ...
    def restock(self, stock):
        ...
        return 'Current '+ self.commodity +f' stock: {self.stock_num}'
...
def store_digits(n):
    ...
    #     last_digit = n % 10
    #     rest_digit = n // 10
    #     return help(rest_digit, Link(last_digit, prev))
    # return help(n//10, Link(n%10))
    result = Link.empty
    while n > 0:
...
def two_list(vals, counts):
    ...
    def helper(val_list):
        if len(val_list) == 0:
            return link.empty
        return link(val_list[0], helper(val_list[1:]))
